#!/system/bin/sh
if ! applypatch --check EMMC:/dev/block/platform/13500000.dwmmc0/by-name/RECOVERY:34431520:6df58e0ec52e8bf741fb72c82cf235bc0382de2f; then
  applypatch \
          --patch /system/recovery-from-boot.p \
          --source EMMC:/dev/block/platform/13500000.dwmmc0/by-name/BOOT:25903648:285c111a620e2a79c1e321d4f75a245a3a0130e9 \
          --target EMMC:/dev/block/platform/13500000.dwmmc0/by-name/RECOVERY:34431520:6df58e0ec52e8bf741fb72c82cf235bc0382de2f && \
